 ...
 * http://github.amexpub.com/modules/component.modal-window
 *
...
module.exports = function(grunt) {
  grunt.initConfig({
    ...
    copy: {
      main: {
        files: [
          {expand: true,cwd: 'dist', src: ['**'], dest: '../../public/periodic/component.modal-window/'},//
          {expand: true,cwd: 'lib', src: ['modal-window.js'], dest: '../../public/periodic/component.modal-window/'}
        ]
      }
    },
    clean: ['../../public/periodic/component.modal-window/'],
    watch: {
      scripts: {
        // files: '**/*.js',
        files: [
